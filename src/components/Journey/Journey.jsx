...
function Journey() {
  const milestones = [
    ...
    },
    {
      ...
      description: "Building frontend and backend development skills.",
    },
    {
      year: "Current",
    ...
    },
    {
      ...
      description: "Working toward becoming a professional software developer.",
    },
  ];
